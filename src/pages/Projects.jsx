            ...
            <div className="h-full flex flex-col border-1 border-zinc-800 rounded-sm bg-zinc-950">
                ...
                <div className="flex h-full overflow-hidden" id="projects-flex-container">
                    ...
                    {showSidebar && (
                        ...
                        >
                            <div className="flex items-center gap-2 p-6 border-b border-zinc-800 w-full">
                                <TbCube className=" text-zinc-400 size-4 " />
                                <p className="text-zinc-200 text-base font-medium cursor-default">Projects</p>
                            </div>
                        </RightSidebar>
                    )}
                </div>
